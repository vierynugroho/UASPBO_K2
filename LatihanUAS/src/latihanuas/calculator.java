...
//    -> Button =
    switch (pilih) {
      case 1:
        ...
        Hasil.setText(penjumlahan.result());

        break;
      case 2:
        angka2 = Double.parseDouble(angka);
        Pengurangan pengurangan = new Pengurangan(angka1, angka2);
        Hasil.setText(pengurangan.result());
        break;
      case 3:
        angka2 = Double.parseDouble(angka);
        Perkalian perkalian = new Perkalian(angka1, angka2);
        Hasil.setText(perkalian.result());
        break;
      case 4:
        angka2 = Double.parseDouble(angka);
        Pembagian pembagian = new Pembagian(angka1, angka2);
        Hasil.setText(pembagian.result());
        break;
      case 5:
        angka2 = Double.parseDouble(angka);
        Modulus modulus = new Modulus(angka1, angka2);
        Hasil.setText(modulus.result());
        break;
      case 6:
        angka2 = Double.parseDouble(angka);
        Pangkat pangkat = new Pangkat(angka1, angka2);
        Hasil.setText(pangkat.result());
        break;
      default:
